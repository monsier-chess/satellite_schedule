...
tiny:
	LD_LIBRARY_PATH=or-tools/lib ./a.out --days 12 --slots 10 --a_days 1 --a_views 3 --b_days 3 --b_views 2 --ratio 2 --objects 10 --matrix data/tiny_limits.txt --types data/tiny_objtype.txt
big:
